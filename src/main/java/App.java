...
public class App {
    ...
    public  static void main(String[] args) {
        ...
        String connectionString = "jdbc:postgresql://localhost:5432/students_system";
        ...
        post("/Students/new", (request, response) -> {
            ...
            Students students = new Students(name,phone,roomNumber,floor,apartmentId);
            studentsDao.saveTenant(students);
        ...
        get("/Students", (request, response) -> {
            ...
            return new ModelAndView(model, "student.hbs");
        }, new HandlebarsTemplateEngine());
        ...
        get("/students/:id",(request, response) ->
        {
            Map<String,Object>model=new HashMap<String, Object>();
            int id = Integer.parseInt(request.params("id"));
            Students found=studentsDao.findById(id);
            model.put("found",found);
            return new ModelAndView(model,"");
        },new HandlebarsTemplateEngine());
